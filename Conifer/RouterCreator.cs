...
namespace Conifer
{
	public class RouterCreator
	{
		...
		public static Router Create(HttpConfiguration httpConfiguration, Action<RouterConfigurationExpression> configure)
		{
			var router = new ConventionalRouter();
			var expression = new RouterConfigurationExpression(router);
			configure(expression);

			var routeBuilder = new Router(router.Routes);
